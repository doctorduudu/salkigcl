    ...
    <div className="home">
        ...
        <Grid container className="borehole-drilling service">
          <Grid item xs={12} className="borehole-drilling-text">
            ...
            >
              ...
              at all locations in Ghana. Get in touch and let's get the purest
              most consistent source of water for your home.
            </Typography>
            <br />
          </Grid>
          <Grid
      ...
      <div id="contact">
        <div style={{ textAlign: "center", margin: "20px 10px" }}>
          ...
          <Typography>
            <strong>Mobile:</strong> 024 330 9856 / 026 643 7445
          </Typography>
          {/* <Typography>
